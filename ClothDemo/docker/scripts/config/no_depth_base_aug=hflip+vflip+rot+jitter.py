...
# model from /home/domen/Projects/center-vector-exp/rtfm/robot_application/backbone=tu-convnext_base_resize_factor=0.5_gpu=1_size=768x768/aug=hflip+vflip+rot+jitter/num_train_epoch=10/depth=False/checkpoint.pth
