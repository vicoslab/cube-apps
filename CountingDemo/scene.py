...
def get_scene(parameters):
    ...
    parameters.state.zerocount_detection = 0
    ...
    def get_docker_texture(gui: Gui, state):
        ...
        return echolib_handler.get_image() if state.zerocount_detection == 1 else echolib_handler.get_camera_stream()
    ...
    def toggle_detection(button: Button, gui: Gui, state):
        ...
        if state.echolib_handler.docker_channel_out is not None:
            ...
            state.zerocount_detection = toggle
